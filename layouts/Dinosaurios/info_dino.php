...
<head>
    ...
    <title><?= $dinosaurio->nombre?> - Información</title>
    <link rel="StyleSheet" href="../../web/css/info_dino.css" type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body>
    <!-- Video-->
    <video autoplay muted loop id="videoFondo">
        <?php if($tipo == "Terrestre"): ?>
                <source src="../../web/videos/fondo-terrestres.mp4" type="video/mp4">
        <?php elseif($tipo == "Acuatico"): ?>
                <source src="../../web/videos/fondo-acuaticos.mp4" type="video/mp4">
        <?php else: ?>
            <source src="../../web/videos/fondo-voladores.mp4" type="video/mp4">
        <?php endif ?>
    </video>
    <a href="tipos_dinosaurios.php?tipo=<?= $tipo ?>" class="btn-volver btn-<?= $tipo ?>">
    ...
    <div class="tarjeta tarjeta-<?= $tipo ?>">
        <div class="cabecera cabecera-<?= $tipo ?>">
            <h1><?= $dinosaurio->nombre ?></h1>
        </div>
        <div class="cuerpo">
            <!-- Imagen -->
            <div class="imagen imagen-<?= $tipo ?>">
                <img src="../../web/img/<?= $dinosaurio->id ?>.jpg" alt="<?= $dinosaurio->nombre ?>">
